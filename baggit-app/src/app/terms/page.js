  ...
  return (
    <div className={styles.termsContainer}>
      ...
      <section className={styles.section}>
        ...
        <p>
          <strong>Eligibility:</strong> To use the app, you must be at least 18
          years old or have permission from a legal guardian.
        </p>
        <p>
          ...
          safeguarding your account credentials and are responsible for any
          activity that occurs under your account.
        </p>
        <p>
          <strong>Account Termination:</strong> We reserve the right to suspend
          or terminate your account if you violate any part of these Terms.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          methods as indicated in the app. By providing payment information, you
          represent that you are authorized to use the payment method.
        </p>
        <p>
          <strong>Refund Policy:</strong> Payments are non-refundable unless the
          storage provider fails to fulfill the service. Refund requests must be
          made within 24 hours of the booking time.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          limited to, hazardous materials, illegal items, and perishable goods.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          providers are responsible for the safekeeping of your items during the
          storage period.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <ul>
          ...
          <li>
            Engage in behavior that disrupts the normal use of the app by other
            users.
          </li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          To the fullest extent permitted by law, BaggIt Bag Storage App and its
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          of the BaggIt Bag Storage App or its licensors. You may not reproduce,
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          <a href="https://baggit-app.vercel.app/privacy">Privacy Policy</a> for detailed information
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          of the app after changes have been posted signifies your acceptance of
          the updated Terms.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          with the laws of The United Kingdom, without regard to its conflict of
          law principles.
        </p>
      </section>
